 ...
 *
 *  Date: Tuesday, September 28, 2021 @ 14:44:04 ET
 *  By: bryancasler
...
var engrid_ENGrid = /*#__PURE__*/function () {
  ...
  createClass_createClass(ENGrid, null, [{
    ...
    value: function setBodyData(dataName, value) {
      var body = document.querySelector("body"); // If value is boolean

      if (typeof value === "boolean" && value === false) {
        body.removeAttribute("data-engrid-".concat(dataName));
        return;
      }

      body.setAttribute("data-engrid-".concat(dataName), value.toString());
    ...
    value: function disableSubmit() {
      ...
      var submitButtonProcessingHTML = "<span class='loader-wrapper'><span class='loader loader-quart'></span><span class='submit-button-text-wrapper'>" + label + "</span></span>";
  ...
  createClass_createClass(ProcessingFees, [{
    ...
    value: function calculateFees() {
      ...
      if (this._field instanceof HTMLInputElement && this._field.checked) {
        ...
        var amountToFee = amount > 0 ? amount : this._amount.amount;
        var processing_fee = parseFloat(fees.processingfeepercentadded) / 100 * amountToFee + parseFloat(fees.processingfeefixedamountadded);
  ...
  createClass_createClass(ApplePay, [{
    ...
    value: function onPayClicked() {
      ...
      if (enFieldPaymentType.value == "applepay" && applePayToken.value == "") {
        try {
          var donationAmount = this._amount.amount + this._fees.fee;
          var request = {
...
var AutoYear = /*#__PURE__*/function () {
  function AutoYear() {
    classCallCheck_classCallCheck(this, AutoYear);
    ...
    if (this.yearField) {
      ...
      for (var i = 0; i < this.years; i++) {
        ...
        var optionText = document.createTextNode(year.toString());
  ...
  createClass_createClass(AutoYear, [{
    key: "clearFieldOptions",
    value: function clearFieldOptions() {
      if (this.yearField) {
...
var Autocomplete = /*#__PURE__*/function () {
  function Autocomplete() {
    classCallCheck_classCallCheck(this, Autocomplete);
  ...
  createClass_createClass(Autocomplete, [{
    key: "autoCompleteField",
    value: function autoCompleteField(querySelector, autoCompleteValue) {
...
var UpsellLightbox = /*#__PURE__*/function () {
  ...
  createClass_createClass(UpsellLightbox, [{
    ...
    value: function popupOtherField() {
      ...
      var upsellAmount = this.getUpsellAmount();
      ...
      live_upsell_amount.forEach(function (elem) {
        return elem.innerHTML = _this3.getAmountTxt(upsellAmount + _this3._fees.calculateFees(upsellAmount));
      });
    }
  }, {
    key: "liveAmounts",
    value: function liveAmounts() {
      ...
      var suggestedAmount = upsellAmount + this._fees.calculateFees(upsellAmount);

      live_upsell_amount.forEach(function (elem) {
        return elem.innerHTML = _this4.getAmountTxt(suggestedAmount);
      });
      live_amount.forEach(function (elem) {
        return elem.innerHTML = _this4.getAmountTxt(_this4._amount.amount + _this4._fees.fee);
      });
    ...
    value: function getAmountTxt() {
      ...
      var symbol = (_a = engrid_ENGrid.getOption("CurrencySymbol")) !== null && _a !== void 0 ? _a : "$";
      var dec_separator = (_b = engrid_ENGrid.getOption("DecimalSeparator")) !== null && _b !== void 0 ? _b : ".";
      var thousands_separator = (_c = engrid_ENGrid.getOption("ThousandsSeparator")) !== null && _c !== void 0 ? _c : "";
      var dec_places = amount % 1 == 0 ? 0 : (_d = engrid_ENGrid.getOption("DecimalPlaces")) !== null && _d !== void 0 ? _d : 2;
      var amountTxt = engrid_ENGrid.formatNumber(amount, dec_places, dec_separator, thousands_separator);
      return amount > 0 ? symbol + amountTxt : "";
    }
  }, {
    key: "checkOtherAmount",
    value: function checkOtherAmount(value) {
      var otherInput = document.querySelector(".upsellOtherAmountInput");
